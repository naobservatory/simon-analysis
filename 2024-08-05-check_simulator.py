...
for _ in range(10):
    ...
    pretty_median = median * 100
    pretty_median = f"{pretty_median:.1f}%"
    pretty_medians.append(pretty_median)
    medians.append(median)

# plt.legend()
# plt.show()
print(*pretty_medians, sep=", ")
mean = np.mean(np.array(medians).astype(float))
pretty_mean = mean * 100
pretty_mean = f"{pretty_mean:.2f}%"
print(f"Mean median: {pretty_mean}")
